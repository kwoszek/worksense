          ...
          <CardHeader>
            <div className="flex items-center gap-4 w-full sm:flex-row flex-col">
              ...
              <div className="flex-1">
                  <Input className="w-full sm:w-[85%] md:w-[60%] bg-transparent mb-1" size="sm" classNames={{input: "text-xl font-semibold", inputWrapper: !editing ? "border-none bg-none shadow-none" : undefined}} disabled={!editing} variant="bordered" value={!editing ? user?.username ?? 'Nieznany' : uname} readOnly={!editing} onValueChange={editing ? setUname : undefined} />
                  <Input className="w-full sm:w-[85%] md:w-[60%] bg-transparent" size="sm" classNames={{input: "text-sm opacity-70", inputWrapper: !editing ? "border-none bg-none shadow-none" : undefined}} disabled={!editing} variant="bordered" value={!editing ? user?.email ?? '' : email} readOnly={!editing} onValueChange={editing ? setEmail : undefined} />
              </div>
              </div>
